...
def test_host_runtime_emits_stages_and_returns_factory_result():
    ...
    host = PromptToAppHost(workflow, HostCapabilities(
    ...
    assert [event.stage for event in events] == ["understand", "research", "blueprint", "generate", "test", "visual_audit", "repair", "github", "deploy", "verify_live", "complete"]
